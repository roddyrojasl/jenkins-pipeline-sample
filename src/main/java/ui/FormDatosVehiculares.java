...
public class FormDatosVehiculares {
    ...
    public static Target CLASE_VEHICULAR_LIST = Target.the("Clase de vehiculo")
                                                 .located(By.xpath("//input//following-sibling::label[contains(text(),'Clase')]/../input"));

    public static Target MARCA_VEHICULO_LIST = Target.the("Marca de vehiculo")
                                                .located(By.xpath("//input//following-sibling::label[contains(text(),'Marca')]/../input"));

    public static Target USO_VEHICULO_LIST = Target.the("Uso de vehiculo")
    ...
    public static Target MODELO_VEHICULO_LIST = Target.the("Modelo de vehiculo")
    ...
    public static Target DEPARTAMENTOS_VEHICULO_LIST = Target.the("Departamentos de vehiculo")
                                                .located(By.xpath("//input//following-sibling::label[contains(text(),'Departamento')]/../input"));

    public static Target PROVINCIA_VEHICULO_LIST = Target.the("Provincia de vehiculo")
                                                .located(By.xpath("//input//following-sibling::label[contains(text(),'Provincia')]/../input"));

    public static Target DISTRITO_VEHICULO_LIST = Target.the("Distrito de vehiculo")
